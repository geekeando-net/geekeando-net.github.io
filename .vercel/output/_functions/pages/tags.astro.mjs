...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const subTitle = "";
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "data-astro-cid-os4i7owy": true }, { "default": async ($$result2) => renderTemplate` ${maybeRenderHead()}<section class="mx-auto max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14" data-astro-cid-os4i7owy> <div class="mx-auto max-w-2xl lg:max-w-5xl" data-astro-cid-os4i7owy> ${renderComponent($$result2, "TitleSection", $$TitleSection, { "title": title, "subTitle": subTitle, "data-astro-cid-os4i7owy": true })} <div class="divide-y divide-neutral-300 dark:divide-neutral-700" data-astro-cid-os4i7owy> <ul class="cloud" role="navigation" aria-label="Webdev tag cloud" data-astro-cid-os4i7owy> ${tags.map((tag) => renderTemplate`<li data-astro-cid-os4i7owy>  <a${addAttribute(tagCounts[tag], "data-weight")}${addAttribute(`/tags/${tag}`, "href")} data-astro-cid-os4i7owy>${tag}</a> </li>`)} </ul> </div> </div> </section> ` })} `;
